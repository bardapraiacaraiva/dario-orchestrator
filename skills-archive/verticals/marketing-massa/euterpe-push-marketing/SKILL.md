...
Every numeric value, name, or factual claim in **euterpe-push-marketing** output must carry an EXPLICIT label so the reader knows what to trust as-is and what needs verification before action.
...
**How to apply in euterpe-push-marketing:**
