...
Every numeric value, name, or factual claim in **risco-reporting** output must carry an EXPLICIT label so the reader knows what to trust as-is and what needs verification before action.
...
**How to apply in risco-reporting:**
