...
Every numeric value, name, or factual claim in **sphinx-cloud-incident-response** output must carry an EXPLICIT label so the reader knows what to trust as-is and what needs verification before action.
...
**How to apply in sphinx-cloud-incident-response:**
