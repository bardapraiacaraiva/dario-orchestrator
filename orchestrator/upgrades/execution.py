...
# M2.1 (Parallel + Loop agents) — extracted to execution_parallel.py (Onda 6 #2)
from upgrades.execution_parallel import (  # noqa: F401
    AgentTask,
    ExecutionMode,
    LoopAgent,
    ParallelAgent,
...
class AgentCardRegistry:
    ...
    def find_best_match(self, requirements: dict) -> AgentCard | None:
        """
...
class RaceExecutor:
    ...
    def race(tasks: list[AgentTask], executor_fn: Callable,
             validator_fn: Callable = None) -> AgentTask | None:
...
class WorkflowVersionStore:
    ...
    def get_version(self, workflow_id: str, version: int = None) -> WorkflowDefinition | None:
